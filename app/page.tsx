...
export default function Page() {
  ...
  return (
    <main className="relative min-h-screen bg-[#070B18] overflow-x-hidden">
      {/* Ambient gradients */}
      <div className="pointer-events-none fixed inset-0 z-0">
        <div className="absolute -top-[400px] left-1/2 h-[900px] w-[1200px] -translate-x-1/2 rounded-full bg-[radial-gradient(ellipse_at_center,rgba(113,90,255,0.18),transparent_65%)] blur-[1px]" />
        <div className="absolute top-[600px] -left-[300px] h-[700px] w-[700px] rounded-full bg-[radial-gradient(ellipse_at_center,rgba(88,135,255,0.12),transparent_65%)]" />
        <div className="absolute top-[300px] -right-[250px] h-[600px] w-[600px] rounded-full bg-[radial-gradient(ellipse_at_center,rgba(166,130,255,0.10),transparent_65%)]" />
        <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(255,255,255,0.02)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.02)_1px,transparent_1px)] bg-[size:72px_72px] [mask-image:radial-gradient(ellipse_at_center,black_50%,transparent_80%)]" />
      </div>

      {/* NAV */}
      <nav className="sticky top-0 z-50 border-b border-white/[0.06] bg-[#070B18]/70 backdrop-blur-xl">
        <div className="mx-auto flex max-w-[1200px] items-center justify-between px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <span className="hidden rounded-full border border-white/10 bg-white/[0.06] px-2 py-0.5 text-[10px] font-medium tracking-widest text-white/70 sm:inline">LOCAL AI</span>
          </div>
          ...
          <div className="hidden items-center gap-3 md:flex">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-full bg-white px-5 py-2.5 text-sm font-semibold text-[#070B18] shadow-lg shadow-white/10 transition hover:bg-white/90 hover:shadow-white/20"
            >
        ...
        {mobileMenu && (
          <div className="border-t border-white/10 bg-[#0F1A32] px-6 py-6 md:hidden">
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div>
            ...
            <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.3 }} className="mt-8 flex flex-wrap items-center gap-4">
              <button
                onClick={handleDownload}
                className="group relative inline-flex items-center gap-3 rounded-full bg-white px-7 py-[14px] text-[15px] font-semibold text-[#070B18] shadow-[0_8px_32px_rgba(255,255,255,0.18)] transition hover:bg-white/90 hover:shadow-[0_12px_40px_rgba(255,255,255,0.25)]"
              >
              ...
              <a href="https://github.com/yuvaang13/Infinit-AI-an-AI-Powered-STEM-tutor-for-K-8-Students" target="_blank" className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/[0.06] px-6 py-[14px] text-sm font-medium text-white backdrop-blur transition hover:bg-white/10">
            ...
            <div className="mt-10 flex items-center gap-6 border-t border-white/5 pt-6">
              <div className="flex -space-x-2">
                <div className="h-8 w-8 rounded-full border-2 border-[#070B18] bg-gradient-to-br from-[#A682FF] to-[#715AFF] flex items-center justify-center text-[10px] font-bold text-white">K8</div>
                <div className="h-8 w-8 rounded-full border-2 border-[#070B18] bg-gradient-to-br from-[#5887FF] to-[#55C1FF] flex items-center justify-center text-[10px] font-bold text-white">AI</div>
                <div className="h-8 w-8 rounded-full border-2 border-[#070B18] bg-[#102E4A] flex items-center justify-center text-[10px] font-bold text-white">30k</div>
              </div>
          ...
          <motion.div initial={{ opacity: 0, y: 24, scale: 0.97 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ duration: 0.9, delay: 0.25 }} className="relative lg:h-[620px]">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="relative h-[520px] w-[520px] max-w-full">
                {/* Rings */}
                <div className="orbit-ring h-[380px] w-[380px] opacity-60" />
                <div className="orbit-ring h-[500px] w-[500px] opacity-30" />
                <div className="absolute left-1/2 top-1/2 h-[280px] w-[280px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(ellipse_at_center,rgba(113,90,255,0.22),transparent_70%)] blur-2xl" />
                {/* Orbiting dots */}
            ...
            {/* Glass window */}
            <div className="relative mx-auto w-full max-w-[440px] overflow-hidden rounded-[24px] border border-white/10 bg-[#0F1A32]/80 shadow-[0_24px_80px_rgba(0,0,0,0.5),0_0_0_1px_rgba(166,130,255,0.1)] backdrop-blur-2xl">
              {/* Window header */}
              ...
              <div className="space-y-4 p-6">
                <div className="flex gap-3">
                  ...
                  <div className="rounded-2xl rounded-tl-sm bg-white px-4 py-3 text-[13px] leading-relaxed text-[#0F1A32] shadow-sm">
                ...
                {/* Input */}
                <div className="flex items-center gap-2 rounded-full border border-white/10 bg-white p-1.5 pl-4 shadow-lg">
            ...
            {/* floating badge */}
            <motion.div animate={{ y: [0, -6, 0] }} transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }} className="absolute -bottom-2 left-2 hidden rounded-2xl border border-white/10 bg-[#0F1A32] p-3 shadow-xl sm:flex items-center gap-3">
            ...
            <motion.div animate={{ y: [0, 6, 0] }} transition={{ duration: 6, repeat: Infinity, ease: "easeInOut", delay: 0.5 }} className="absolute -right-2 top-20 hidden rounded-2xl border border-white/10 bg-white p-3 shadow-xl sm:flex items-center gap-3">
              ...
              <div>
                <div className="text-xs font-semibold text-[#0F1A32]">30k entries</div>
      ...
      <section className="relative z-10 mx-auto mt-16 max-w-[1200px] px-6">
        <div className="rounded-2xl border border-white/5 bg-white/[0.03] px-6 py-4 backdrop-blur">
      ...
      <section id="features" className="relative z-10 mx-auto max-w-[1200px] px-6 pt-20">
        ...
        <div className="mt-10 grid gap-4 md:grid-cols-3">
          {[
            ...
            <div key={f.title} className="group relative overflow-hidden rounded-[20px] border border-white/5 bg-white/[0.03] p-6 backdrop-blur transition hover:border-[#A682FF]/20 hover:bg-white/[0.05]">
      ...
      <section id="how" className="relative z-10 mx-auto max-w-[1200px] px-6 pt-20">
        <div className="grid gap-8 lg:grid-cols-2">
          <div>
            <div className="inline-flex rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs font-semibold tracking-widest text-white/60">HOW IT WORKS</div>
            ...
            <div className="mt-8 space-y-6">
              {[
                ...
                <div key={s.n} className="flex gap-4 rounded-2xl border border-white/5 bg-white/[0.03] p-5">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-white text-sm font-bold text-[#070B18]">{s.n}</div>
                  <div>
          ...
          <div className="relative overflow-hidden rounded-[24px] border border-white/10 bg-[#0F1A32] p-6">
            <div className="absolute -right-20 -top-20 h-64 w-64 rounded-full bg-[radial-gradient(ellipse_at_center,rgba(113,90,255,0.25),transparent_70%)] blur-2xl" />
            <div className="relative">
              ...
              <div className="mt-6 rounded-xl bg-gradient-to-br from-[#715AFF] to-[#A682FF] p-[1px]">
                <div className="rounded-[11px] bg-[#070B18] px-4 py-3 flex items-center justify-between">
                  <div className="flex items-center gap-3">
      ...
      <section id="models" className="relative z-10 mx-auto max-w-[1200px] px-6 pt-20">
        <div className="flex flex-wrap items-end justify-between gap-4">
          ...
          <span className="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-white/60">V4 recommended</span>
        </div>
        <div className="mt-6 grid gap-3 md:grid-cols-4">
          {[
            ...
            <div key={m.v} className={`rounded-2xl border p-5 ${m.active ? "border-[#A682FF]/30 bg-[#A682FF]/10" : "border-white/5 bg-white/[0.03]"}`}>
              <div className="flex items-center justify-between">
      ...
      <section className="relative z-10 mx-auto max-w-[1200px] px-6 pt-16">
        <div className="relative overflow-hidden rounded-[32px] border border-white/10 bg-gradient-to-br from-[#0F1A32] via-[#101D3A] to-[#0F1A32] p-8 md:p-12">
          <div className="absolute -right-32 -top-32 h-[480px] w-[480px] rounded-full bg-[radial-gradient(ellipse_at_center,rgba(166,130,255,0.18),transparent_65%)] blur-2xl" />
          <div className="absolute -left-32 -bottom-32 h-[420px] w-[420px] rounded-full bg-[radial-gradient(ellipse_at_center,rgba(85,193,255,0.12),transparent_65%)] blur-2xl" />
          ...
          <div className="relative grid items-center gap-8 lg:grid-cols-[1.1fr_0.9fr]">
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <button
                  onClick={handleDownload}
                  className="inline-flex items-center gap-3 rounded-full bg-white px-8 py-4 text-sm font-semibold text-[#070B18] shadow-[0_12px_40px_rgba(255,255,255,0.15)] transition hover:bg-white/90"
                >
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-6 backdrop-blur">
              ...
              <div className="mt-6 rounded-xl bg-white p-4 flex items-center gap-3">
                ...
                <div className="flex-1">
                  <div className="text-sm font-semibold text-[#070B18]">Install in 2 minutes</div>
      ...
      {/* FOOTER */}
      <footer className="relative z-10 mt-16 border-t border-white/5 bg-black/20 backdrop-blur">
      ...
      <div className={`fixed bottom-6 left-1/2 z-50 -translate-x-1/2 transition-all duration-300 ${showToast ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0 pointer-events-none"}`}>
        <div className="flex items-center gap-3 rounded-full border border-white/10 bg-[#0F1A32]/90 px-5 py-3 shadow-2xl backdrop-blur-xl">
